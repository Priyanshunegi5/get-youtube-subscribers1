...
/**
 * Asynchronously delete a subscribed with the provided request data.
 *
...
const remove = async (req, res, next) => {
    ...
    // Delete a record using subscribed model
    subscribed.delete({ id: param?.id },(record) => {
        if(!record) {
            throw "subscribed not deleted!";
        }
