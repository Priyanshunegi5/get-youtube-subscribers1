...
/**
 * Asynchronously delete a subscriber with the provided request data.
 *
...
const remove = async (req, res, next) => {
    ...
    // Delete a record using subscribers model
    subscribers.delete({ id: param?.id },(record) => {
        if(!record) {
            throw "subscriber not deleted!";
        }
